...
public class WriteIndexFile 
{
	...
	static void StartWriteIndex(String indexPath, Path file, Employee emp) {
	...
	static void indexDoc(IndexWriter writer, Path file, Employee emp) throws IOException 
	{
		try (InputStream stream = Files.newInputStream(file)){ 
			...
			doc.add(new TextField("macrini",emp.getName() , Store.YES));
