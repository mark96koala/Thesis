...
public class JsonCreation {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		while(i>50){
			...
			objectMapper.writeValue(new File("serializedFiles/To"+i+".json"), to1);
			
			StringWriter stringEmp2 = new StringWriter();
			Ql ql1 = createQlObject();
			objectMapper.writeValue(stringEmp2, ql1);    
			System.out.println("To Json is\n"+stringEmp2);
			objectMapper.writeValue(new File("serializedFiles/Ql"+i+".json"), ql1);
			...
			System.out.println("To Json is\n"+stringEmp3);
			objectMapper.writeValue(new File("serializedFiles/SimulatoreTo"+i+".json"), SimTo);
			...
			System.out.println("To Json is\n"+stringEmp4);
			objectMapper.writeValue(new File("serializedFiles/SimulatoreFrom"+i+".json"), SimFrom);
