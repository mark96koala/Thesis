...
public class TestJsonCreation {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		while(i<50){
			...
			objectMapper.writeValue(stringEmp1, to1);    
			System.out.println("To Json is\n"+stringEmp1);
			objectMapper.writeValue(new File("inputFiles/To"+i+".json"), to1);

			StringWriter stringEmp2 = new StringWriter();
			Ql ql1 = createQlObject();
			ql1.setNumero_ciclo(i);
			objectMapper.writeValue(stringEmp2, ql1);    
			System.out.println("Ql Json is\n"+stringEmp2);
			objectMapper.writeValue(new File("inputFiles/Ql"+i+".json"), ql1);
			...
			System.out.println("SimTo Json is\n"+stringEmp3);
			objectMapper.writeValue(new File("inputFiles/SimulatoreTo"+i+".json"), SimTo);
			...
			objectMapper.writeValue(new File("inputFiles/SimulatoreFrom"+i+".json"), SimFrom);
