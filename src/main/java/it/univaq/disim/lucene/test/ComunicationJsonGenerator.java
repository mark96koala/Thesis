...
public class ComunicationJsonGenerator {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		while(i<50){
			...
			objectMapper.writeValue(file1, to1);  
			byte[] jsonData1 = Files.readAllBytes(Paths.get(file1.getPath())); 
			...
			objectMapper.writeValue(file2, ql1);  
			byte[] jsonData2 = Files.readAllBytes(Paths.get(file2.getPath())); 
			...
			objectMapper.writeValue(file3, SimTo);  
			byte[] jsonData3 = Files.readAllBytes(Paths.get(file3.getPath())); 
			...
			objectMapper.writeValue(file4, SimFrom); 
			byte[] jsonData4 = Files.readAllBytes(Paths.get(file4.getPath()));
